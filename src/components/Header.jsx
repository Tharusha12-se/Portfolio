        ...
        <header className="absolute w-full z-50 transition-all duration-300">
            <div className="container  mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 md:h-20">
                ...
                <nav className="lg:flex hidden space-x-8">
                    {["Home", "About", "Project", "Experince", "Contact"].map((item, index) => (
                        <motion.a key={item}
                ...
                <div className="md:flex hidden  items-center space-x-5">
                    ...
                    <motion.a
                        ...
                        href="" className="text-gray-700 dark:text-gray-300 hover:text-violet-600 dark:hover:text-violet-400
            ...
            text-violet-700 font-bold hover:to-purple-700 hover:text-white transition-all
            duration-500">
                        Hire Me
                    </motion.button>
                </div>
            ...
            className="md:hidden overflow-hidden bg-white dark:bg-gray-900 shadow-lg px-4 py-5 space-y-5">
                ...
                <nav className=" flex flex-col space-y-3">
                    {["Home", "About", "Project", "Experince", "Contact"].map((item) => (
                        <a className="text-gray-300 font-medium py-2"
                        onClick={toggleMenu}
                        kay = {item} href="#">
                            {item}
                        </a>
                ...
                className="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-md p-6">
                    ...
                    <form action="" className="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea rows="4" type="text" id="message" placeholder="How can we help you?"
                            className="w-full px-4 py-2 border border-gray-600 rounded-lg focus:ring-2
                            focus:ring-violet-500 focus:border-violet-500 bg-gray-700"/>
                        </div>
